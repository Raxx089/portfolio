...
const About = () => {
  ...
  const [state] = React.useState([
    { id: 1, title: "Name:", text: "Rahul Sharma" },
    { id: 2, title: "Email:", text: "raxx089@gmail.com" },
    { id: 3, title: "Phone:", text: "+91-8250769860" },
    { id: 4, title: "Linkedin", text: "linkedin.com/in/rahul-sharma-892ba6a5" },
  ]);
  return (
    <div className="about">
